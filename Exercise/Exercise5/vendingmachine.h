...
enum FoodType{
    Latte,//0 least delicious //coffee
    Cappuccino,//coffee
    Americano,//most populat type of coffee, //coffee
    Milk,
    Chocolate,
    Bread,
    Chips,
...
class CoffeeVendor : public VendingMachine{//继承类
